...
public class MealsUtil {
    ...
    public static void main(String[] args) {
        ...
        List<MealTo> mealsWithExcess = getFilteredWithExcess(MEALS, 2000);
        mealsWithExcess.forEach(System.out::println);

        List<MealTo> mealsWithExcess0 = getFilteredWithExcess1(MEALS, LocalTime.of(7, 0), LocalTime.of(12, 0), 2000);
        mealsWithExcess0.forEach(System.out::println);
        System.out.println();
...
//                      Collectors.toMap(Meal::getDate, Meal::getCalories, Integer::sum)
    ...
    public static List<MealTo> getFilteredWithExcess1(List<Meal> meals, LocalTime startTime, LocalTime endTime, int caloriesPerDay) {
        Map<LocalDate, Integer> caloriesSumByDate = meals.stream()
                .collect(
                        Collectors.groupingBy(Meal::getDate, Collectors.summingInt(Meal::getCalories))
//                      Collectors.toMap(Meal::getDate, Meal::getCalories, Integer::sum)
